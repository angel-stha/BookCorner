...
class MyProfile extends Component{
    ...
    DeleteReview=(title,review,date)=>{
        var data= {
            ...
            axios.post('http://54.165.178.5:3303/DeleteReview', data)
                .then(res => {
    ...
    var data= {
        ...
        date: date,
         ...
         axios
            .post("http://54.165.178.5:3303/EditReview", data)
    ...
    componentDidMount() {
        ...
        axios.post("http://54.165.178.5:3303/getmydata",)
            .then(res => {
        ...
        axios.get("http://54.165.178.5:3303/getrevieweddata")
    ...
    axios.get("http://54.165.178.5:3303/ipinged")
